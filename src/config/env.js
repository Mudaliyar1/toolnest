...
module.exports = {
  ...
  mongoUri: process.env.MONGODB_URI || 'mongodb://127.0.0.1:27017/toolnest',
  sessionSecret: process.env.SESSION_SECRET || 'toolnest-session-secret',
  cookieSecret: process.env.COOKIE_SECRET || 'toolnest-cookie-secret',
